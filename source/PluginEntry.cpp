/**
    ...
    the `CFFGLPluginInfo` that Rosette.cpp registers at static-initialisation
    ...
    binary: which build it is.
        ...
        strings Rosette.bundle/Contents/MacOS/Rosette | grep rosette
*/

extern "C" const char* RosetteBuildStamp()
{
	return "rosette " ROSETTE_VERSION " built " __DATE__ " " __TIME__;
}
